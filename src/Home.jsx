...
import img1 from './assert/i.jpeg'; // Import the image directly, not using destructuring
import img2 from './assert/ii.jpeg'; // Import the image directly, not using destructuring
